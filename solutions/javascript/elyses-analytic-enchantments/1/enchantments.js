...
export function isEachCardEven(stack) {
  return stack.every(isEvenNumber);
}
...
export function getFirstEvenCardPosition(stack) {
  return stack.findIndex(isEvenNumber);
}


//helper functions
const isEvenNumber = (/** @type {number} */ num) => num % 2 === 0;
